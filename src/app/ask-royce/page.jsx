...
const AskRoycePage = () => {
  return (
    <PageShell>
      ...
      <section id="archive" className="relative bg-navy-900 text-moonlight py-14 lg:py-32 overflow-hidden">
        <div
          aria-hidden="true"
              ...
              >
                ...
                <div className="grid grid-cols-12 gap-6 lg:gap-10">
                  ...
                  <div className="col-span-12 lg:col-span-9">
                    <h3 className="font-display font-extrabold text-[24px] lg:text-[30px] leading-[1.2] text-white">
                      {faq.topic}
                    </h3>
